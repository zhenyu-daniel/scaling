...
exp_log = logging.getLogger("Experimental Registry")
...
class ExperimentalRegistry(object):
    def __init__(self):
        self.exp_specs = {}
    ...
    def register(self, id, **kwargs):
        ...
        self.exp_specs[id] = ExperimentSpec(id, **kwargs)


# Global agent registry
exp_registry = ExperimentalRegistry()
