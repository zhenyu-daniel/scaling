...
class Torch_MLP_Generator(torch.nn.Module, Generator):
    """
    ...
    def __init__(self, config, module_chain, devices="cpu"):
        super(Torch_MLP_Generator, self).__init__()
    ...
    def train(self, noise, real_norms,optimizer,num_events=1, data_dim=2):
        """
